        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="eventForm" role="form" method="post" action="{{ route('admin.events.update', $event->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview img-thumbnail" data-trigger="fileinput"
                                            ...
                                            @if($event->coverImage)
                                                ...
                                                <input name="cover_image_id" value="{{ $event->coverImage->id }}" type="hidden">
                                            @endif
                                        </div>
                                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="location" name="location" class="form-control"
                                           placeholder="enter location" value="{{ old('location', $event->location) }}">
                        ...
                        <div class="form-group {{ $errors->has('start_time') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="start_time" name="start_time"  value="{{ old('start_time', $event->start_time) }}" class="form-control" placeholder="select a time">
                                </div>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('end_time') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="end_time" name="end_time" value="{{ old('end_time', $event->end_time) }}" class="form-control" placeholder="select a time">
                                </div>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('sign_up_due_time') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="sign_up_due_time" name="sign_up_due_time" value="{{ old('sign_up_due_time', $event->sign_up_due_time) }}" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="group_limit" name="group_limit" class="form-control"
                                           placeholder="enter group user limit" value="{{ old('group_limit', $event->group_limit) }}">
                                </div>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('is_top') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="checkbox" name="is_top" value="{{ old('is_top', $event->is_top) }}" {{ old('is_top', $event->is_top) == '1' ? 'checked' : '' }} class="switch_is_top">
                                </div>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('is_front') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="checkbox" name="is_front" value="{{ old('is_front', $event->is_front) }}" {{ old('is_front', $event->is_front) == '1' ? 'checked' : '' }} class="switch_is_front">
                                </div>
                            </div>
