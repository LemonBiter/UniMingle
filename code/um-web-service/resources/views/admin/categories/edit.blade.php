            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <form id="categoryForm" role="form" method="post" action="{{ route('admin.categories.update', $category->id) }}" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-preview img-thumbnail" data-trigger="fileinput"
                                                ...
                                                @if($category->coverImage)
                                                    <img id={{ $category->coverImage->id }} src="{{ $category->coverImage->url }}"/>
                                                    <input name="cover_image_id" value="{{ $category->coverImage->id }}" type="hidden">
                                                @endif
                                            </div>
                                            <div>
