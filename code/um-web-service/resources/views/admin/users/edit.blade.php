        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form id="postForm" role="form" method="post" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="nationality" name="nationality" class="form-control"
                                           placeholder="enter nationality" value="{{ old('nationality', $user->nationality) }}">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview img-thumbnail" data-trigger="fileinput"
                                            ...
                                            <input name="profile_image_id" value="{{ $user->avatar->id }}" type="hidden">
                                            @endif
                                        </div>
                                        <div>
                                        ...
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-preview img-thumbnail" data-trigger="fileinput"
                                                ...
                                                @if($user->studentIdImage)
                                                    <img id={{ $user->studentIdImage->id }} src="{{ $user->studentIdImage->url }}"/>
                                                    <input name="studentId_image_id" value="{{ $user->studentIdImage->id }}" type="hidden">
                                                @endif
                                            </div>
                                            <div>
                                        <span class="btn btn-outline-secondary btn-file">
