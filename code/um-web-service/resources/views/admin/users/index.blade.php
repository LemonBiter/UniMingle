        ...
        @if(count($users))
            ...
            @foreach($users as $l)
                <div class="col-md-3 item{{ $l->id }}">
                    <a href="{{ route('admin.users.show',$l->id) }}">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button class="btn btn-success btn-rounded waves-effect waves-light m-t-10"
                                    onclick="location.href = '{{ route('admin.users.edit',$l->id) }}';">Edit
                            </button>
                            {{--<button class="btn btn-danger btn-rounded waves-effect waves-light m-t-10" data-toggle="modal" data-id="{{ $l->id }}" data-target="#delete_modals">Delete--}}
