        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="couponForm" role="form" method="post" action="{{ route('admin.coupons.update', $coupon->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="name" name="name" class="form-control"
                                           placeholder="enter name" value="{{ old('name', $coupon->name) }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="code" name="code" class="form-control"
                                           placeholder="enter code" value="{{ old('code', $coupon->code) }}">
                                </div>
                            </div>
                            <small class="form-control-feedback">{{ $errors->first('name') }}</small>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control " id="description"
                                              name="description" rows="5">{{ old('description', $coupon->description) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="discount" name="discount" class="form-control"
                                           placeholder="enter discount" value="{{ old('discount', $coupon->discount) }}">
                                </div>
                            </div>
                        ...
                        <div class="form-group {{ $errors->has('start_time') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="start_time" name="start_time" value="{{ old('start_time', $coupon->start_time) }}"
                        ...
                        <div class="form-group {{ $errors->has('end_time') ? 'has-danger' : '' }}">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="end_time" name="end_time" value="{{ old('end_time', $coupon->end_time) }}"
                                           class="form-control" placeholder="select a time">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="total_usage" name="total_usage" class="form-control"
                                           placeholder="enter total usage" value="{{ old('total_usage', $coupon->total_usage) }}">
                                </div>
                            </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            @else
            select2_business.val({!! $coupon->business->id !!}).trigger('change');
            @endif
            ...
            @else
            select2_discountType.val({!! $coupon->discountType->id !!}).trigger('change');
            @endif
        });
    </script>
@endpush
