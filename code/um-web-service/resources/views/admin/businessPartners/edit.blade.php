...
@section('content_header')
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Edit Business Partner</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                <li class="breadcrumb-item active">Edit Business Partner</li>
            </ol>
        </div>
    </div>
@stop
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="businessPartnerForm" role="form" method="post" action="{{ route('admin.businessPartners.update', $businessPartner->id) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="name" name="name" class="form-control"
                                           placeholder="enter name" value="{{ old('name', $businessPartner->name) }}">
                                </div>
                            </div>
                                    ...
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-preview img-thumbnail" data-trigger="fileinput"
                                            ...
                                            @if($businessPartner->logo)
                                                <img id={{ $businessPartner->logo->id }} src="{{ $businessPartner->logo->url }}"/>
                                                <input name="logo_id" value="{{ $businessPartner->logo->id }}" type="hidden">
                                            @endif
                                        </div>
                                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <textarea class="form-control " id="description"
                                              name="description" rows="5">{{ old('description', $businessPartner->description) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="location" name="location" class="form-control"
                                           placeholder="enter location" value="{{ old('location', $businessPartner->location) }}">
                                    <input type="hidden" name="lat" id="lat" value="{{ old('lat', $businessPartner->lat) }}">
                                    <input type="hidden" name="lng" id="lng" value="{{ old('lng', $businessPartner->lng) }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="phone" name="phone" class="form-control"
                                           placeholder="enter phone" value="{{ old('phone', $businessPartner->phone) }}">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="website" name="website" class="form-control"
                                           placeholder="enter website" value="{{ old('website', $businessPartner->website) }}">
                                </div>
                            </div>
...
@push('js')
    ...
    <script>
        $(document).ready(function () {
            ...
            @else
            select2_category.val({!! $businessPartner->category->id !!}).trigger('change');
            @endif
